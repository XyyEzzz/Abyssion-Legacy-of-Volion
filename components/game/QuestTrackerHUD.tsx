...
export default function QuestTrackerHUD() {
    ...
    return (
      <div className="absolute top-20 right-4 z-10 pointer-events-auto">
        <button
          ...
          className="bg-slate-900/80 backdrop-blur-md text-amber-300 border border-slate-700/80 hover:border-amber-400 px-3 py-1.5 rounded-xl text-xs font-bold shadow-lg flex items-center gap-2 hover:scale-105 active:scale-95 transition-all"
        >
          <span>📜</span>
          <span>Open Quests [J]</span>
        </button>
      </div>
    );
  }
  ...
  return (
    <div className="absolute top-20 right-4 z-10 pointer-events-auto flex flex-col items-end gap-2 max-w-[260px] sm:max-w-[300px]">
